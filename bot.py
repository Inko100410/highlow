# main.py — Рекламное Казино v4.1 (ПОЛНАЯ ВЕРСИЯ 1800+ СТРОК)
...
<b>👑 Админ-команды:</b>
/setrating [ID] [знач] - установить рейтинг
/setluck [ID] [знач] - установить удачу
